...
public class Bootcamp {
	...
	private Set<Dev> devsInscricao = new HashSet<Dev>();
	...
	@Override
	public int hashCode() {
		return Objects.hash(conteudos, dataFinal, dataInicial, descricao, devsInscricao, nome);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(conteudos, other.conteudos) && Objects.equals(dataFinal, other.dataFinal)
				...
				&& Objects.equals(devsInscricao, other.devsInscricao) && Objects.equals(nome, other.nome);
	}
